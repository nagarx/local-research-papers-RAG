...
class TestRAGSystemFunctionality:
    ...
    def test_embedding_generation(self):
        ...
        # Check if embedding contains numbers (handles numpy types)
        import numpy as np
        assert isinstance(embedding[0], (int, float, np.number)), "Embedding should contain numbers"
        ...
        print(f"✅ Single embedding: {len(embedding)} dims, Batch: {len(embeddings)} embeddings")
    ...
    def test_vector_storage_operations(self):
        ...
        print(f"✅ Added doc, searched, found {len(results)} results")
    ...
    def test_document_processing(self, sample_documents):
        ...
        print(f"✅ Processed {test_doc.name}, {len(result['content']['blocks'])} blocks")
    ...
    def test_end_to_end_rag_query(self, sample_documents):
        ...
        print(f"✅ Response: {len(response['response'])} chars, Sources: {len(response['sources'])}")
    ...
    def test_source_tracking(self):
        ...
        print(f"✅ Created reference, formatted citation: '{citation}'")
    ...
    def test_system_health_check(self):
        ...
        print(f"✅ Status: {health['overall_status']}, Components: {len(components)}")
